...
// TWGOperations
#define COCOAPODS_POD_AVAILABLE_TWGOperations
#define COCOAPODS_VERSION_MAJOR_TWGOperations 0
#define COCOAPODS_VERSION_MINOR_TWGOperations 1
#define COCOAPODS_VERSION_PATCH_TWGOperations 0

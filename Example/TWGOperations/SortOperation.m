...
+ (NSArray *)sortedArrayOfSortableObjects:(NSArray<SortableObject *> *)objects
{
    ...
    NSArray *sortedArray =
        [sortableArray sortedArrayWithOptions:NSSortStable
                              usingComparator:^NSComparisonResult(SortableObject *obj1, SortableObject *obj2) {

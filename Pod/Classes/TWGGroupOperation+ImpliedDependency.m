...
{
    [operations enumerateObjectsWithOptions:NSEnumerationReverse usingBlock:
     ^(NSOperation * _Nonnull operation, NSUInteger idx, BOOL * _Nonnull stop) {
         
        NSIndexSet *previousOperationsIndexes = [NSIndexSet indexSetWithIndexesInRange:NSMakeRange(0, idx)];
        NSArray *previousOperations = [operations objectsAtIndexes:previousOperationsIndexes];
